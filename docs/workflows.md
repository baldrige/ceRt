...
dispatches its own successor before exiting. A cron-started run that finds a
watcher already in progress exits at once. See **[data-sources.md](data-sources.md)**.
