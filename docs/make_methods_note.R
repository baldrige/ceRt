...
<style>
  ...
  *{box-sizing:border-box} html{-webkit-text-size-adjust:100%%}
  ...
  .kicker{font:600 8pt/1 "Newsreader";letter-spacing:.2em;text-transform:uppercase;color:var(--accent);margin:0 0 .3rem}
  ...
  h2{font-family:"Fraunces",Georgia,serif;font-weight:600;font-size:11pt;color:var(--accent);margin:.5rem 0 .2rem;border-bottom:1px solid var(--rule);padding-bottom:2px}
